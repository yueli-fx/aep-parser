...
func runStructuralGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/generated/args/structural_ops_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/generators/verify_structural_ops.jsx`
