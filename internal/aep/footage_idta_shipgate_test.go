...
func runFootageIdtaGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/generated/args/footage_idta_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/generators/verify_footage_idta.jsx`
