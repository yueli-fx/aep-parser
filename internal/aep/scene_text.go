...
// decodeTextSource parses a Layer.TextSourceRaw payload into a
// TextSource. Returns nil + a warning string if anything in the
// PostScript tree is missing or malformed; the raw bytes stay
// accessible via Layer.TextSourceRaw for downstream tools.
