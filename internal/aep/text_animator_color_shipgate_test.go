...
func runTextColorGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/text_animator_color_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/verify_text_animator_color.jsx`
