...
func runMGMaskOpacityGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/mg_mask_opacity_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/verify_mg_mask_opacity.jsx`
