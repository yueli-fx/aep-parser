...
func runCompDuplicateGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/comp_duplicate_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/verify_comp_duplicate.jsx`
