...
func buildFieldSummaries() map[string]string {
	out := map[string]string{
		...
		"project.expression_engine":                      "Project expression engine.",
...
func addLayerSummaries(out map[string]string, prefix string) {
	addSummaries(out, prefix, map[string]string{
		...
		"text_animators[]":              "Text animator definitions.",
		"text_animators[].property":     "Text animator property to add.",
		"text_animators[].value":        "Text animator property value.",
		"text_animators[].range_start":  "Text animator range selector start percentage.",
		"text_animators[].range_end":    "Text animator range selector end percentage.",
		"text_animators[].range_offset": "Text animator range selector offset percentage.",
		"text_animators[].range_offset_keyframes[]":                    "Range selector offset keyframes.",
		"text_animators[].range_offset_keyframes[].time":               "Range selector offset keyframe time in seconds.",
		"text_animators[].range_offset_keyframes[].value":              "Range selector offset keyframe value.",
		"text_animators[].range_offset_keyframes[].in_ease":            "Incoming temporal ease for the keyframe.",
		"text_animators[].range_offset_keyframes[].out_ease":           "Outgoing temporal ease for the keyframe.",
		"text_animators[].range_offset_keyframes[].in_ease.speed":      "Incoming temporal ease speed.",
		"text_animators[].range_offset_keyframes[].in_ease.influence":  "Incoming temporal ease influence percentage.",
		"text_animators[].range_offset_keyframes[].out_ease.speed":     "Outgoing temporal ease speed.",
		"text_animators[].range_offset_keyframes[].out_ease.influence": "Outgoing temporal ease influence percentage.",
		"text_animators[].value_keyframes[]":                           "Text animator value keyframes.",
		"text_animators[].value_keyframes[].time":                      "Text animator value keyframe time in seconds.",
		"text_animators[].value_keyframes[].value":                     "Text animator value keyframe value.",
		"text_animators[].value_keyframes[].in_ease":                   "Incoming temporal ease for the keyframe.",
		"text_animators[].value_keyframes[].out_ease":                  "Outgoing temporal ease for the keyframe.",
		"text_animators[].value_keyframes[].in_ease.speed":             "Incoming temporal ease speed.",
		"text_animators[].value_keyframes[].in_ease.influence":         "Incoming temporal ease influence percentage.",
		"text_animators[].value_keyframes[].out_ease.speed":            "Outgoing temporal ease speed.",
		"text_animators[].value_keyframes[].out_ease.influence":        "Outgoing temporal ease influence percentage.",
...
func addTextStyleSummaries(out map[string]string, prefix, label string) {
	addSummaries(out, prefix, map[string]string{
		...
		"caps_option":         label + " caps option.",
		"baseline_option":     label + " baseline option.",
		"auto_kern_type":      label + " auto-kerning type.",
		"line_join_type":      label + " stroke line-join type.",
		"digit_set":           label + " digit set.",
		...
		"first_line_indent":   label + " paragraph first-line indent.",
		"start_indent":        label + " paragraph start indent.",
		"end_indent":          label + " paragraph end indent.",
		"space_before":        label + " paragraph space before.",
		"space_after":         label + " paragraph space after.",
		"auto_hyphenate":      label + " paragraph auto-hyphenation switch.",
		"leading_type":        label + " paragraph leading type.",
		"hanging_roman":       label + " paragraph hanging Roman punctuation switch.",
		"paragraph_direction": label + " paragraph reading direction.",
	})
}
...
func addExpectedProfileSummaries(out map[string]string) {
	addSummaries(out, "expected_profile", map[string]string{
		...
		"expression_engine":                      "Expected project expression engine.",
