...
//
// prin/prda templates were RE'd from the reference parser's renderer_{classic_3d,advanced_3d, //nolint:jargon
...
// prin layout (104B), per the reference parser's binary/misc_chunks.py PrinChunk:
//
...
// disk). Mirrors the reference parser's composition.py _RENDERER_EXTENDSCRIPT_TO_BINARY. Only
...
// prda default-option payload. RE'd from the reference parser's renderer fixtures. //nolint:jargon
