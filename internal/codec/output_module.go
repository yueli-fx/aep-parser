...
// Byte layout mirrors the reference parser's binary/render_chunks.py; offsets
// verified by field-size accounting + a scratch probe script + golden cross-check.
...
// Field offsets mirror the reference parser's binary/render_chunks.py Ropt variant classes;
