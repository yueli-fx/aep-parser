...
func runTextRotGate(t *testing.T, aeExe, ver string, target aep.AETarget) {
	...
	const argsPath = `e:/projects/tools/aep-parser/test_data/generated/args/text_animator_rotation_args.json`
	const jsxPath = `E:/projects/tools/aep-parser/test_data/generators/verify_text_animator_rotation.jsx`
