...
//
// AE ship gate: Rect Size keyframe persistence gate.
...
func runV2_2RectKfShipGate(t *testing.T, target aep.AETarget, aeExe string) {
	...
	argsPath := `e:/projects/tools/aep-parser/test_data/generated/args/v2_2_rectkf_args.json`
	...
	jsxPath := `E:/projects/tools/aep-parser/test_data/generators/verify_v2_2_rectkf.jsx`
