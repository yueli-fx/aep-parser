...
func runLayerAVFields2ShipGate(t *testing.T, target aep.AETarget, aeExe string) {
	...
	argsPath := `e:/projects/tools/aep-parser/test_data/generated/args/layer_av_fields2_args.json`
	...
	jsxPath := `E:/projects/tools/aep-parser/test_data/generators/verify_layer_av_fields2.jsx`
