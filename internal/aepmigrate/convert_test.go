...
func TestConvertWritesRecipeTextEffectProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-text-effect.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertWritesRecipeAdjustmentEffectProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-adjustment-layer.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertWritesRecipeEffectLayerParamProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-effect-layer-param.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertWritesRecipeEffectParamExpressionProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-effect-param-expression.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertWritesRecipeEffectParamKeyframesProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-effect-param-keyframes.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertWritesRecipeEffectParamVectorKeyframesProject(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-effect-param-vector-keyframes.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
...
func TestConvertRefusesUnsupportedGradientStrokeLayerProjects(t *testing.T) {
	source := writeTempRecipe(t, filepath.Join("..", "..", "examples", "recipes", "minimal-shape-gradient-stroke.json"))
	outPath := filepath.Join(t.TempDir(), "converted.aep")
