...
type ProjectSpec struct {
	...
	LinearBlending                     *bool    `json:"linear_blending,omitempty"`
	LinearizeWorkingSpace              *bool    `json:"linearize_working_space,omitempty"`
	TimeDisplayType                    string   `json:"time_display_type,omitempty"`
	FramesCountType                    string   `json:"frames_count_type,omitempty"`
	FramesUseFeetFrames                *bool    `json:"frames_use_feet_frames,omitempty"`
	FeetFramesFilmType                 string   `json:"feet_frames_film_type,omitempty"`
	FootageTimecodeDisplayStartType    string   `json:"footage_timecode_display_start_type,omitempty"`
	ExpressionEngine                   string   `json:"expression_engine,omitempty"`
...
type TextStyleSpec struct {
	...
	ParagraphDirection string    `json:"paragraph_direction,omitempty"`
}
