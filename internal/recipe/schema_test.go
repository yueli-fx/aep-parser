...
func TestValidateReportsProjectDisplayScalarCapabilities(t *testing.T) {
	rec := minimalRecipe()
	enabled := true
	...
	assertCapability(t, report, "Project.SetTimecodeDefaultBase")
	assertCapability(t, report, "Project.SetTransparencyGridThumbnails")
}
...
func TestValidateRejectsInvalidProjectDisplayScalars(t *testing.T) {
	rec := minimalRecipe()
	rec.Project.TimecodeDefaultBase = intPtr(1000)
	...
	assertRefusal(t, report, "invalid_project_timecode_default_base")
}
...
func TestValidateReportsTextAnimatorOpacityCapability(t *testing.T) {
	...
	assertCapability(t, report, "AddTextOpacityAnimator")
}

func TestValidateReportsTextAnimatorPositionCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
	...
	assertCapability(t, report, "AddTextPositionAnimator")
}

func TestValidateReportsTextAnimatorScaleCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
	...
	assertCapability(t, report, "AddTextScaleAnimator")
}

func TestValidateReportsTextAnimatorRotationCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
	...
	assertCapability(t, report, "AddTextRotationAnimator")
}

func TestValidateReportsTextAnimatorColorCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
...
func TestValidateReportsTextAnimatorCharacterOffsetCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
	...
	assertCapability(t, report, "AddTextCharacterOffsetAnimator")
}

func TestValidateReportsTextAnimatorFillOpacityCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
...
func TestValidateReportsTextAnimatorStrokeWidthCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
...
func TestValidateReportsTextAnimatorRangeOffsetCapability(t *testing.T) {
		...
		TextAnimators: []recipe.TextAnimatorSpec{
			{
				...
				RangeEnd:    ptr(100),
				RangeOffset: ptr(0),
				RangeOffsetKeyframes: []recipe.ScalarKeyframe{
					{Time: 0, Value: 0},
					{Time: 2, Value: 100},
				},
			},
	...
	assertCapability(t, report, "AnimateTextRangeOffset")
}

func TestValidateReportsTextAnimatorOpacityValueKeyframesCapability(t *testing.T) {
	rec := minimalRecipe()
	rec.Comps[0].Layers[0] = recipe.Layer{
		Type: "text",
		Name: "Title",
