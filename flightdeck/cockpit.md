...
- **roundtrip 剩 122,域分布**:render-queue 40(多无 ScriptingAPI,acceptance 顶,期望低)· layer-set 28(残:material advanced 8/3D-geometry 3=不可达双版本(AE2020 无 ray-traced/Advanced-3D)· source/alternate/light-source 需特殊载体· trackmatte explicit 4=单版本已验· bool 残 Stretch/AutoOrient/IsNull/audio/frameblend/collapse/effects/timeremap 需载体)· project 19(多 header/flag→acceptance)· meta 10(**read/helper,ae-accept 不适用,非目标**)· comp 6(idta RE)· text 6(硬尾)· io 4 · shape 3(RE)· expr 2(closed)· keyframe 1(defer)。
