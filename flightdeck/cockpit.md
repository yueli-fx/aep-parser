...
- **aep-understanding-generation Phase 3**：按 `work/aep-understanding-generation/phase3-plan.md` 实现 sentinel frame selection / sidecar metadata / PNG compare / `cmd/aeoracle`；暂不进入 gap ledger 或生成器。
