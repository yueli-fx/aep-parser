...
- **roundtrip 剩 102,域分布(便宜双版本 DOM 验已真正榨干)**:render-queue 40(acceptance 顶)· layer-set 25(material-advanced 8/3D-geometry 3=不可达双版本· trackmatte-explicit 4=单版本验· 2 false-green-alpha=SetStretch/SetTimeRemapEnabled· audio/frameblend 需音视频源· alternate-source 2/light-source AE24+ niche· markers-locked 无 DOM)· project 11(WorkingGamma/AudioSampleRate/Gpu/TimecodeBase/TranspGrid 无 DOM 或假绿· lnrp 已记假绿· CMS 4=AE24+ 需既有 CMS chunk·SetPath 需 footage 载体)· meta 10(read/helper N/A)· comp 3(**SetDraft3D 已记 false-green** · Guide SetPosition/Orientation 无 DOM)· text 4(animator+kerning 硬尾)· io 4(footage SetComment/Label 共用批21修复未单独验 · WriteAEP/WriteJSON N/A)· shape 3(RE)· expr 1(closed)· keyframe 1(defer)。
- **下一批候选(已无便宜双版本 DOM)**:① shape 3 match-name RE(Repeater/Wiggler Anchor/Scale)· ② footage SetComment/SetLabel(批21 修复已覆盖机制,建 footage 载体 gate 即可双版本,**ROI 高**)· ③ 需音视频载体(audio/frameblend,造素材)· ④ render-queue/project header 走 acceptance-preservation(量大、tier 低于 ae-accept)。再推任一方向都比批1-20 贵,**择一深入,非顺手 drain**。
