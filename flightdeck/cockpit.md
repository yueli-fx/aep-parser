...
- **aep-understanding-generation Phase 1 人工审核点**：确认新 profile JSON shape 后，再进入 Phase 2 `internal/profilediff` / `cmd/aepdiff`；暂不进入 render oracle 或生成器。
