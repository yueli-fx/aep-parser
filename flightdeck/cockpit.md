...
**Last updated**: 2026-06-11 by claude（effect 库 ship-gate 补齐：余 7 效果 ×2 AE 版本 14/14 PASS → 全 12 模板双版本 gated，gate 表扩到全库——详 `incidents/add-effect-splice-re.md`）
...
1. **NewTextLayer**（新建图层类型最后一块；详 `incidents/new-layer-types-scoping.md`）：✅ Camera/Light + Solid/Null/Adjustment 已 ship。embed-whole-Layr 可行，但 btdk 文本 blob 复杂。
