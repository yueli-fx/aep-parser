...
**Last updated**: 2026-06-11 by claude（AddEffect vein 收口：库扩到 29 全 gated + New\* 六 API 升 Stable + `SetEffectParam` 参数物化（synthesis-lite + 泛型 control-type 模板，scalar/enum/bool 即设即用）+ ae_run Abort action exit 7——详 `incidents/effect-param-elision-synthesis-lite.md` + git log 322ea00..4691042）
