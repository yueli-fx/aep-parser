...
**➡ 下一步 = 优先级4 mask**（AddMask/RemoveMask + mode/color/inverted 已 ship；剩 Feather/Opacity 属性 · SetMaskPath 改写 · animated mask path · maskFeatherFalloff 探位）。详 roadmap spec 优先级4。
