...
**Last updated**: 2026-06-17 by claude（effects layer-ref 第二波收口：wave 11 ship 3D Glasses/Warp Stabilizer/Timewarp/CC Particle World，双版本 ship-gate PASS，库 203→207，incident add-effect-splice-re § Wave 11。另：删退役 deferred-backlog spec + per-version-template spec 加 ldta-164 交叉链接。）
