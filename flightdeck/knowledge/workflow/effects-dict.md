...
SUMMARY: AE 效果参数字典 — dump 流程 + 使用指南
READ WHEN: 要给新 AE 版本(2027/2028…)生成效果参数字典;想知道某 matchName/参数槽的人类语义或默认值;实现工具消费字典(翻译参数名、按 default 识别用户调过的参数);AE 切语言后脚本写文件报 Permission denied;dump 脚本输出 0KB
