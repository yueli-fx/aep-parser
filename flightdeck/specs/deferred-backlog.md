...
- **Essential Graphics W**（创建 controller / 绑定 override UUID）—— py-aep parity 路线图（归档 `archive/specs/2026-05-26-py-aep-parity-design.md`）收尾后仅存的真未实现写线头（Gradient stroke W 已于 2026-06-10 ship，见 coverage 子项⑯）
