...
### 进行中·完成（active·done）
- [2026-06-10-gradient-stroke-write.md](2026-06-10-gradient-stroke-write.md) — active — GradientStroke W（最小·对称已 ship 的 GradientFill）：加 GradientStrokeNode 只 model gradient color/alpha stops，克隆从 fixture 提取的 G-Stroke 模板 + 覆写 prop.map XML（复用 codec + overwriteGradientStopsXML），新增 enum/match-name/lower + 双版本 ship-gate。stroke 几何 + ramp geometry deferred
