...
- [2026-05-22-v3-direction.md](2026-05-22-v3-direction.md) — active — V3 direction：scene-graph IR + capability matrix + serializer split（Phase 1-5 + 包重组方案① + M8 scene→rifx 白名单清零 已落；真·物理分包(方案②接口倒置)执行中 P2 5/10）
<!-- /AUTO -->
