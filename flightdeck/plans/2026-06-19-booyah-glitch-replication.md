...
- [ ] **Step 3(下一):** effect 链:Geometry2 Scale Height(`-0003`,L0/L1 7kf anim、L2–L6 静态 157/248/144…)/ Glo2(L7×2 Add、L8×1)/ Gaussian Blur(L23×2、L24×1)/ Fractal Noise(L24/L26,Evolution expr time*3000/time*2000)= 全是 ③/⑦ 已验 SetEffectParam/AnimateEffectParam 套路。**唯一 RE 未知 = Displacement Map 层引用**(L10–L20 共 12 个 `ADBE Displacement Map`):layer-ref 在 tdpi(非标量,`-0001` 标量读 0 是 elided),需读原版每个 map 的 tdpi 目标层 + `SetEffectLayerParam` 指向 clone 对应层(源应是隐藏 noise 层 L24/L25/L26 之一,待 RE 确认)。L19/L20 Max H/V 有 anim kf。
