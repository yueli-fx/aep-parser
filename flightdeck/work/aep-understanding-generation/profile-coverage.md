...
| Composition settings | ID/name/size/fps/duration | plus tick rate, renderer, work area, bg, shutter/motion blur, markers/guides/EG | Admit ID/name/size/fps/duration/tick/render/work area/motion blur, comp markers, comp guides, and EG controller summaries | L1_parsed | Renderer/work area affect render and slice selection. |
