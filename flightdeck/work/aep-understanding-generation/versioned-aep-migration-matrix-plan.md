...
- `go run ./cmd/aepmigrate matrix -recipes examples\recipes -sources AE2020 -targets AE2020,AE2022,AE2025 -out tmp\migration_matrix_smoke_all`
  - Result after layer metadata, text-layer switch, and text-parent convert
    slices: 423 total, 201 pass, 222 blocked, 0 failed, 0 skipped; command
    exits 1 because intentional blocked cases remain.
