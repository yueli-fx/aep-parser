...
- Versioned AEP migration convert first slice is implemented as
  ...
  light object-profile/light-source, layer object-profile, text-effect,
  adjustment-effect, and effect layer-ref outputs.
...
- Layer mask writer coverage was upgraded from `PD-1x3` to full W2020-W2025
  source-and-target coverage. The matrix
...
- Text layer baseline writer coverage was upgraded from the latest full
  `PD-1x6` boundary to focused W2020-W2025 source-and-target coverage. The
  matrix `tmp/migration_matrix_text_baseline_all_6x6/matrix.json` is 72 total,
