...
go run ./cmd/aepregistry coverage-md -root . -coverage flightdeck/work/aep-understanding-generation/versioned-aep-migration-coverage.json -out tmp/migration_coverage.md
