---
status: active
when_to_read: 往 samples/ 加参考工程当学习样本（建文件夹该长啥样、放哪些文件、怎么分类、readme 写啥）；批量采集后做归置；纠结某工程算哪个题材
applies_to: [sample-library, samples-layout, reference-project, folder-convention, classification, genre, readme-template, cover, license, no-reprint, appledouble-cleanup, gitignore]
last_updated: 2026-06-18
---

# 往 samples/ 加参考工程 — 文件夹约定 + 分类
