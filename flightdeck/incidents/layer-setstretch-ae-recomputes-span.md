---
status: active
when_to_read: 实现/调试 Layer.SetStretch;给层设时间拉伸 Go round-trip 绿但 AE 读 layer.stretch=100;以为 @0x08/0x6C 分子分母够;评估 time-stretch 是否要协调 in/out
applies_to: [stretch, time-stretch, layer-set, false-green, red-line-1, ldta, 0x08, 0x6C, in-out-span, ae-recompute, roundtrip-not-ae, alpha]
...
## Cases
- 2026-06-17 首次。补验 arc layer-bool 批,SetStretch(0.5) 双载体均 AE reset 100。AutoOrient/CollapseTransform 同批正常升 ae-accept;SetStretch 隔离为 alpha false-green。同族教训:[[comp-setframerate-no-duration-rescale]](时间字段交互)· [[btdk-point-value-needs-formatpsreal]](单写值假绿)。
