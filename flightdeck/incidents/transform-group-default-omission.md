---
status: active
when_to_read: 我们解出的 Transform Group 属性比 py-aep golden 少；以为 parser 截断/desync；ADBE Orientation 在 tree 里是空 group
applies_to: [parser, property-stream, transform-group, 3d-layer, default-omission, synthesis-gap, otst, negative-finding]
