---
status: active
when_to_read: 实现/调试 Layer.SetTimeRemapEnabled;启用时间重映射 Go 不报错但 AE 读 timeRemapEnabled=false;以为设静态值 0.0 够;TimeRemapEnabled getter 与 SetTimeRemapEnabled 不自洽
applies_to: [time-remap, layer-set, false-green, red-line-1, timeRemapEnabled, identity-keyframes, static-value, roundtrip-not-ae, alpha, getter-setter-inconsistent]
