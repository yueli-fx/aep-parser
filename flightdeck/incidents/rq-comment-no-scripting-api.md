---
status: active
when_to_read: 给 RenderQueueItem 加 comment/字段 setter；设计某个"无 ScriptingAPI 的二进制字段"的 ship-gate；想用 JSX readback 验证 RQ 字段却拿到 undefined
applies_to: [renderqueue, rcom, scripting-api-gap, ship-gate, binary-only-field, acceptance-preservation, negative-finding]
