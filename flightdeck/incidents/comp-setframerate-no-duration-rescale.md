---
status: active
when_to_read: 实现/调试 Composition.SetFrameRate 或 SetDuration;AE 打开后合成时长被 newFps/oldFps 缩放;给 comp 同时改帧率+时长;批量 comp-settings fixture
applies_to: [composition, cdta, SetFrameRate, SetDuration, ticksPerFrame, MasterTicks, nominal-tickrate, duration-rescale, frame-rate-interaction, ae-read-mismatch, comp-settings-gate]
