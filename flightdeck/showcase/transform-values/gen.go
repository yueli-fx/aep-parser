// flightdeck/showcase/transform-values/gen.go — from-scratch (no AE) showcase of
...
//
// Run from the repo root: `go run ./flightdeck/showcase/transform-values`.
package main
...
const outPath = "flightdeck/showcase/transform-values/transform_values.aep"
