// flightdeck/showcase/rain/gen.go — from-scratch, plugin-free rain showcase.
...
//
// Run from repo root: `go run ./flightdeck/showcase/rain`.
package main
...
const outPath = "flightdeck/showcase/rain/rain.aep"
...
func applyMainEffects(comp *aep.Composition) error {
	...
	if err := set(echoL, echo, "ADBE Echo-0001", -0.045); err != nil {
		return err
	}
	...
	if err := set(echoL, blur, "ADBE Gaussian Blur 2-0001", 2.5); err != nil {
		return err
	}
	...
	if err := set(echoL, glow, "ADBE Glo2-0002", 108.0); err != nil {
		return err
	}
	if err := set(echoL, glow, "ADBE Glo2-0003", 18.0); err != nil {
		return err
	}
	if err := set(echoL, glow, "ADBE Glo2-0004", 0.7); err != nil {
		return err
	}
	...
	if err := set(mistL, fn, "ADBE Fractal Noise-0004", 54.0); err != nil {
		return err
	}
	if err := set(mistL, fn, "ADBE Fractal Noise-0005", -92.0); err != nil {
		return err
	}
	if err := set(mistL, fn, "ADBE Fractal Noise-0011", 620.0); err != nil {
		return err
	}
	if err := set(mistL, fn, "ADBE Fractal Noise-0012", 180.0); err != nil {
		return err
	}
	if _, err := aep.AnimateEffectParamVec(mistL, fn, "ADBE Fractal Noise-0013",
		[]aep.VectorKeyframe{{Time: 0, Value: []float64{820, 520}}, {Time: 4, Value: []float64{1280, 710}}}); err != nil {
		return err
	}
	if err := set(mistL, fn, "ADBE Fractal Noise-0029", 18.0); err != nil {
		return err
	}
