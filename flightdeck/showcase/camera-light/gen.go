// flightdeck/showcase/camera-light/gen.go — from-scratch (no AE) showcase of
...
// Run from repo root: `go run ./flightdeck/showcase/camera-light`.
package main
...
const outPath = "flightdeck/showcase/camera-light/camera_light.aep"
