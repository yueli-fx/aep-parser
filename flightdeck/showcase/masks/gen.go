// flightdeck/showcase/masks/gen.go — from-scratch (no AE) showcase of the
...
//
// Run from the repo root: `go run ./flightdeck/showcase/masks`.
package main
...
const outPath = "flightdeck/showcase/masks/masks.aep"
