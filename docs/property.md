...
SetDimensionsSeparated toggles AE's "Separate Dimensions" on a Position leader. Alpha / structural. Both directions (separate↔merge) are implemented for static AND animated Position; an animated leader routes to the keyframe-stream migration paths (separatePositionAnimated / mergePositionAnimated), both ship-gated AE 2020+2025.
