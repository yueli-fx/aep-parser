...
- error_type: —
- where: `showcase/booyah-clone/gen_precomp1.go` (any gen building a `LayerTransform` for `SetLayerTransform`)
...
Related: [shape-layer-position-default-offscreen](shape-layer-position-default-offscreen.md) (the separated-Position centering
workaround, a sibling transform-read trap) · [setlayertransform-av-anchor-fraction](setlayertransform-av-anchor-fraction.md)
(anchor units) · [ntsc-tickrate-derive-3x-off](../composition/ntsc-tickrate-derive-3x-off.md) (the tdb4 keyframe-TIME fix that was the
