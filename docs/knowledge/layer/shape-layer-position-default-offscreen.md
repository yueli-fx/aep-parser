...
- ❌ `Layer.SetPosition(v)` — goes through `l.Position()` = `PropertyByMatchName("ADBE Position")`,
  ...
  This is the transform-group default-omission / property-synthesis gap ([transform-group-default-omission](../property/transform-group-default-omission.md)).
