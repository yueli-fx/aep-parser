...
## Cases
- 2026-06-17 首次。补验 arc layer-flags2 批,SetTimeRemapEnabled(true) AE 读回 false;同批 SetEffectsEnabled/SetIsNull 正常升 ae-accept。同族 false-green:[layer-setstretch-ae-recomputes-span](layer-setstretch-ae-recomputes-span.md)(单写值 AE 不认)· [comp-setframerate-no-duration-rescale](../composition/comp-setframerate-no-duration-rescale.md)。
