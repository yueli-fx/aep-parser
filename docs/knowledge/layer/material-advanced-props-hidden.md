...
- 同源教训家族：[layer-3d-enable-bit-materializes](layer-3d-enable-bit-materializes.md)（3D 通道 default-omission）· [transform-group-default-omission](../property/transform-group-default-omission.md)（属性合成缺口）· delivery-contract 红线1（值/字节对 ≠ AE 认）。
