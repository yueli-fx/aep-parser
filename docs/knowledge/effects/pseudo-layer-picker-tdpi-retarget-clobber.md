...
1. **Shared-core blanket retarget.** `addEffectFromChunks` (the splice core
   ...
   [add-effect-splice-re](add-effect-splice-re.md) Finding 5). But `BuildPseudoEffect` **synthesizes**
...
- 2026-06-20 first seen — BuildPseudoEffect layer-picker side-arc (continuation
  of the [pseudo-control-label-ansi-codepage](pseudo-control-label-ansi-codepage.md) / pseudo value-entry work).
