...
[add-mask-create-re](add-mask-create-re.md) 掀出 encodeBezier 的 geometry lhd3 写 `@0x14=n / @0x18=closedFlag / @0x1C=16`，
...
详 [add-mask-create-re](add-mask-create-re.md) §三 finding 4。
