...
相关：[separate-dimensions-write-mechanics](../keyframe-expression/separate-dimensions-write-mechanics.md)（同 tdmn+payload pair 机制的姊妹案例）、
[ae-deletelayer-re](../layer/ae-deletelayer-re.md)（同 V2.1 atomic invariants pattern）。
