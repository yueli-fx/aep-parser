// showcase/shape-filters/gen.go — from-scratch (no AE) showcase of the
...
// file. Run from the repo root: `go run ./showcase/shape-filters`.
//
...
const outPath = "showcase/shape-filters/shape_filters.aep"
