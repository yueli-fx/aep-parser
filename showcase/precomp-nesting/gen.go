// showcase/precomp-nesting/gen.go — from-scratch (no AE) showcase of
...
// Run from repo root: `go run ./showcase/precomp-nesting`.
package main
...
const outPath = "showcase/precomp-nesting/precomp_nesting.aep"
