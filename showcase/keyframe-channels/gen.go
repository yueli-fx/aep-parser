// showcase/keyframe-channels/gen.go — from-scratch (no AE) showcase of
...
// Run from repo root: `go run ./showcase/keyframe-channels`.
package main
...
const outPath = "showcase/keyframe-channels/keyframe_channels.aep"
