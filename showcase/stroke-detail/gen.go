// showcase/stroke-detail/gen.go — from-scratch (no AE) showcase of the
...
//
// Run from the repo root: `go run ./showcase/stroke-detail`.
//
// ─────────────────────────────────────────────────────────────────────────────
...
const outPath = "showcase/stroke-detail/stroke_detail.aep"
