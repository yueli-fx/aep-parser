// showcase/expressions/gen.go — from-scratch (no AE) showcase of the
...
// expressions.aep next to this file. Run: `go run ./showcase/expressions`.
...
const outPath = "showcase/expressions/expressions.aep"
...
func main() {
	...
	must(err)
	_, err = aep.SetEffectParam(sldL, fx, "Slider", 1500.0)
	must(err)
