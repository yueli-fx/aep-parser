// showcase/structural-ops/gen.go — from-scratch (no AE) showcase of
...
//
// Run from the repo root: `go run ./showcase/structural-ops`.
package main
...
const outPath = "showcase/structural-ops/structural_ops.aep"
