...
regenerate: "go run ./showcase/structural-ops  +  scripts/ae-worker/ae_run.ps1 render.jsx"
---
...
V3 结构性 op（adaptive block-splice + atomic rollback）：[能力矩阵](../../docs/capabilities.md) § "V3 Composition layer structural ops"；维度分离：`incidents/separate-dimensions-write-mechanics.md`。
