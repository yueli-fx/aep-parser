// showcase/gradient/gen.go — from-scratch (no AE) showcase of gradient
...
// Run from repo root: `go run ./showcase/gradient`.
package main
...
const outPath = "showcase/gradient/gradient.aep"
