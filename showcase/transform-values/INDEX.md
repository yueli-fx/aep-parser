...
regenerate: "go run ./showcase/transform-values  +  scripts/ae-worker/ae_run.ps1 render.jsx"
---
...
Layer transform 5 通道（Position/Anchor/Scale/Rotation/Opacity）持久化：[能力矩阵](../../docs/capabilities.md) § V2.2.1 子项⑥；gate：`TestV2_2_XfKf_AEShipGate_*`（AE 读回 user 单位 scale/rot/opacity 正确）。
