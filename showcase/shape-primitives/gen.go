// showcase/shape-primitives/gen.go — from-scratch (no AE) showcase of
...
// Run from repo root: `go run ./showcase/shape-primitives`.
package main
...
const outPath = "showcase/shape-primitives/shape_primitives.aep"
