// showcase/3d-camera/gen.go — from-scratch (no AE) showcase of the
...
// Run from repo root: `go run ./showcase/3d-camera`.
package main
...
const outPath = "showcase/3d-camera/3d_camera.aep"
