// showcase/comp-settings/gen.go — from-scratch (no AE) showcase of
...
// Run from repo root: `go run ./showcase/comp-settings`.
package main
...
const outPath = "showcase/comp-settings/comp_settings.aep"
...
func main() {
	...
	// Distinctive, non-default settings.
	must(comp.SetResolutionFactor(2, 2))             // DOM resolutionFactor = [2,2] (Half)
