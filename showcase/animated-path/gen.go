// showcase/animated-path/gen.go — from-scratch (no AE) showcase of an
...
// Run from repo root: `go run ./showcase/animated-path`.
package main
...
const outPath = "showcase/animated-path/animated_path.aep"
