...
//
// Outputs:
//   test_data/generated/ship-gate/verify_ge_move_layer_<mode>.done
...
(function () {
    ...
    if (!spec) {
        var errFile = new File("e:/projects/tools/aep-parser/test_data/generated/ship-gate/verify_ge_move_layer_unknown.done");
        errFile.open("w");
    ...
    var aepPath  = "e:/projects/tools/aep-parser/test_data/generated/ship-gate/ge_move_layer_" + mode + ".aep";
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/generated/ship-gate/verify_ge_move_layer_" + mode + ".done");
    var log = ["mode=" + mode];
