...
// the project save to test_data/fixtures/re_text.aep so the user's original
...
(function () {
    var outFile = new File("e:/projects/tools/aep-parser/test_data/fixtures/re_text.aep");
    var log = [];
