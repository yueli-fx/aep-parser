...
//
// Outputs:
//   test_data/generated/ship-gate/verify_ge_insert_layer_<tag>.done   (tag defaults to mode)
...
(function () {
    ...
    if (!spec) {
        var errFile = new File("e:/projects/tools/aep-parser/test_data/generated/ship-gate/verify_ge_insert_layer_unknown.done");
        errFile.open("w");
    ...
    var aepPath  = "e:/projects/tools/aep-parser/test_data/generated/ship-gate/ge_insert_layer_" + mode + ".aep";
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/generated/ship-gate/verify_ge_insert_layer_" + tag + ".done");
    var log = ["mode=" + mode];
