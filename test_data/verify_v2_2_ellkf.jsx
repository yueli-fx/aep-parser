// test_data/verify_v2_2_ellkf.jsx — V2.2.1 Ellipse Size+Position keyframe gate.
// Asserts AE accepts an Ellipse with animated Size + Position, re-saves for
// Go-side keyframe decode. args: v2_2_ellkf_args.json.
(function () {
    var argsFile = new File("e:/projects/tools/aep-parser/test_data/v2_2_ellkf_args.json");
