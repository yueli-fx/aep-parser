...
// Outputs:
//   test_data/verify_ge_duplicate_layer_explicit_matte.done
//      first line:  ae=<version>
//      subsequent lines: per-step OK / ERR + post-open layer dump
//      LAST line:   PASS or FAIL <reason>
(function () {
    var aepPath  = "e:/projects/tools/aep-parser/test_data/ge_duplicate_layer_explicit_matte.aep";
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/verify_ge_duplicate_layer_explicit_matte.done");
    var log = [];
