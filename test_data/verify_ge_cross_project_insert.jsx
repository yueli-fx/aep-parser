...
//
// Outputs:
//   test_data/verify_ge_cross_project_insert_<tag>.done
...
(function () {
    ...
    if (!validModes[mode]) {
        var errFile = new File("e:/projects/tools/aep-parser/test_data/verify_ge_cross_project_insert_unknown.done");
        errFile.open("w");
    ...
    var aepPath  = "e:/projects/tools/aep-parser/test_data/ge_cross_project_insert_" + mode + ".aep";
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/verify_ge_cross_project_insert_" + tag + ".done");
    var log = ["mode=" + mode];
