// test_data/verify_open_batch.jsx
//
...
(function () {
    var argsFile = new File("e:/projects/tools/aep-parser/test_data/verify_open_batch_args.json");
    var summary = new File("e:/projects/tools/aep-parser/test_data/verify_open_batch_summary.txt");
    var items = [];
