...
// Output: test_data/re_effect_param_elision_2025.aep + .done
(function () {
    var outFile  = new File("e:/projects/tools/aep-parser/test_data/re_effect_param_elision_2025.aep");
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/re_effect_param_elision_2025.done");
    var log = [];
