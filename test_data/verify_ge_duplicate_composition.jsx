...
//
// Outputs:
//   test_data/verify_ge_duplicate_composition_<tag>.done   (LAST line PASS/FAIL)
(function () {
    var tag = $.getenv("GE_DUP_TAG");
    if (tag === null || tag === "") tag = "default";

    var aepPath  = "e:/projects/tools/aep-parser/test_data/ge_duplicate_composition.aep";
    var doneFile = new File("e:/projects/tools/aep-parser/test_data/verify_ge_duplicate_composition_" + tag + ".done");
    var log = ["tag=" + tag];
