...
var extractions = []extraction{
	...
	{"data/reference/shape/v2_2_shape_all_full.aep", "ADBE Vector Shape - Rect", "internal/serializer/templates/shapes/rect_body.bin"},
	{"data/reference/shape/v2_2_shape_all_full.aep", "ADBE Vector Graphic - Fill", "internal/serializer/templates/shapes/fill_body.bin"},
	{"data/reference/shape/v2_2_shape_all_full.aep", "ADBE Vector Shape - Ellipse", "internal/serializer/templates/shapes/ellipse_body.bin"},
	{"test_data/fixtures/v2_2_shape_path_tolerance.aep", "ADBE Vector Shape - Group", "internal/serializer/templates/shapes/path_body.bin"},
	{"data/reference/shape/v2_2_shape_all_full.aep", "ADBE Vector Graphic - Stroke", "internal/serializer/templates/shapes/stroke_body.bin"},
	...
	{"data/reference/shape/v2_2_stroke_dashed.aep", "ADBE Vector Graphic - Stroke", "internal/serializer/templates/shapes/stroke_dashed_body.bin"},
	...
	{"data/reference/shape/v2_2_gradient_type.aep", "ADBE Vector Graphic - G-Fill", "internal/serializer/templates/shapes/gradfill_body.bin"},
	...
	{"data/reference/shape/v2_2_gradstroke_geom.aep", "ADBE Vector Graphic - G-Stroke", "internal/serializer/templates/shapes/gradstroke_body.bin"},
	...
	{"data/reference/shape/v2_2_trim.aep", "ADBE Vector Filter - Trim", "internal/serializer/templates/shapes/trim_body.bin"},
	...
	{"data/reference/shape/v2_2_repeater.aep", "ADBE Vector Filter - Repeater", "internal/serializer/templates/shapes/repeater_body.bin"},
	...
	{"data/reference/shape/v2_2_roundcorners.aep", "ADBE Vector Filter - RC", "internal/serializer/templates/shapes/roundcorners_body.bin"},
	...
	{"data/reference/shape/v2_2_offset.aep", "ADBE Vector Filter - Offset", "internal/serializer/templates/shapes/offset_body.bin"},
	...
	{"data/reference/shape/v2_2_merge.aep", "ADBE Vector Filter - Merge", "internal/serializer/templates/shapes/merge_body.bin"},
	...
	{"data/reference/shape/v2_2_zigzag.aep", "ADBE Vector Filter - Zigzag", "internal/serializer/templates/shapes/zigzag_body.bin"},
	...
	{"data/reference/shape/v2_2_star.aep", "ADBE Vector Shape - Star", "internal/serializer/templates/shapes/star_body.bin"},
	...
	{"data/reference/shape/v2_2_polygon.aep", "ADBE Vector Shape - Star", "internal/serializer/templates/shapes/starpolygon_body.bin"},
	...
	{"data/reference/shape/v2_2_puckerbloat.aep", "ADBE Vector Filter - PB", "internal/serializer/templates/shapes/puckerbloat_body.bin"},
	...
	{"data/reference/shape/v2_2_twist.aep", "ADBE Vector Filter - Twist", "internal/serializer/templates/shapes/twist_body.bin"},
	...
	{"data/reference/shape/v2_2_wiggle.aep", "ADBE Vector Filter - Roughen", "internal/serializer/templates/shapes/wiggle_body.bin"},
	...
	{"data/reference/shape/v2_2_wiggletransform.aep", "ADBE Vector Filter - Wiggler", "internal/serializer/templates/shapes/wiggletransform_body.bin"},
}
